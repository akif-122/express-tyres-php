                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="card-body blog-content">
                            <h4 class="mb-4">15 Tips to Ensure Long-Lasting Tyres: Expert Advice by xpress-tyres
                            </h4>
                            <div class="row">
                        ...
                        <div class="related-blog card">
                            ...
                            <div class="card-body">
                                <p class="border-bottom m-0 py-2">
                                    <a href="#"><i class="fa-solid fa-caret-right"></i> Xpress-Tyres: Your Ultimate
                                        Guide to Mobile Tyre Fitting</a>
                                </p>
                                <p class="border-bottom m-0 py-2">
                                    <a href="#"><i class="fa-solid fa-caret-right"></i> Emergency Tyre Changing Services
                                        in Manchester – xpress-tyres is Here To Help</a>
                                </p>
                                <p class=" m-0 py-2">
                                    <a href="#"><i class="fa-solid fa-caret-right"></i> 15 Tips to Ensure Long-Lasting
                                        Tyres: Expert Advice by xpress-tyres</a>
                                </p>
                            </div>
